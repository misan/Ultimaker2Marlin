...
void readTemps()
{
    ...
    // variables are only accesible from the ISR, but static, so they don't lose their value
...
#endif //PIDTEMP
//-----------------------------------------------------------------------------------------------------------------
// diagnostic, useful for creating thermistor tables via console and extrernal temp probe..
    void report_temps()
    {
        SERIAL_ECHO_START;

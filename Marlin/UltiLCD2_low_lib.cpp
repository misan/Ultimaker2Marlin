...
void lcd_lib_draw_string_rightP(uint8_t y, const char* str, byte startpos)
	{
	lcd_lib_draw_stringP(startpos - lcd_lib_get_string_lengthP(str) , y, str);		// move 2 pixels in fom extreme right side
	}

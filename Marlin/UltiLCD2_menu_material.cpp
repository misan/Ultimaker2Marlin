...
{
    {(("GENERIC PLA")   )  , 225, 70, 100, 100, 2.85},
    {(("GENERIC ABS")   )  , 255, 95,  0, 107, 2.85},
    {(("IC3D ABS")      )  , 245, 95,  0, 107, 2.85},
    {(("JET ABS")       )  , 255, 95,  0, 107, 2.95},
    {(("ECOFLEX PLA")   )  , 235, 75, 100, 110, 2.85},
    {(("T 618 NYLON")   )  , 245, 45, 100, 120, 2.85},
    {(("TGLASE/PET+")   )  , 225, 70, 100, 120, 2.9 },
    {(("NINJAFLEX")     )  , 245, 55, 100, 135, 2.7 },
    {(("POLYCARB")      )  , 295,110, 100, 110, 2.85}
};
    ...
    while(cnt < max_mats+EXTRUDERS)
        {
			...
			memset (material_name_buf,0,MATERIAL_NAME_LENGTH);
...
void makeCustomName( uint8_t idx )
{
    ...
    buf+= '0'+idx - 1 - MATERIAL_PRESETS+2;

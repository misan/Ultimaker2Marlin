...
#define     X_STEP_PIN               25
#define     X_DIR_PIN                23
#define     X_STOP_PIN               26 // 22
#define     X_ENABLE_PIN             27

#define     Y_STEP_PIN               32
#define     Y_DIR_PIN                33
#define     Y_STOP_PIN               22 // 26 
...
#define		HEAD_FAN_PIN			 16//  30	 //	// keeps the extruder cool		J-23
#define		MOTHERBOARD_FAN			 38		// cools the stepper controllers		J-23
#define		STEPPER_FAN_PIN			 13
#define		AUX_POWER_OUT1			30
#define		AUX_POWER_OUT2			58
#define		AUX_POWER_OUT3			59



// ------------------------------------------------- POWER MANAGEMENT------------------------------------------------------------------
#define     PS_ON_PIN                12
#define     EXT_VOLTAGE_REF_PIN		 60		// A0 -- set to a known voltage level / reference for calibrating the ADC		j-25
...
#define     TEMP_SENSOR_PIN			 61		// A1 -- ambient environment sensor, such as a DHT11		j-25

#define		HEAD_TEMP_SENSOR_PIN	54
#define		STEPPER_TEMP_SENSOR_PIN	55
#define		MOBO_TEMP_SENSOR_PIN	56
#define		HEAD_AUX_TEMP_SENSOR_PIN 57
